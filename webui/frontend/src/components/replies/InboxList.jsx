...
// Other / Done & dismissed), one row per reply, email-client style.
  ...
  return (
    <div className={`inbox-row${active ? ' active' : ''}${dim ? ' dim' : ''}`}
      ...
      <div className="meta">
        ...
        {it.handled && <span style={{ color: 'var(--green)' }}>replied ✓</span>}
...
export default function InboxList({ sections, selectedId, onSelect }) {
  return (
